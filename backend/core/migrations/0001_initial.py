    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_pto', models.CharField(blank=True, choices=[('//', '//'), ('PTO et CAB absents', 'PTO et CAB absents'), ('Remise en conformité', 'Remise en conformité'), ('NE', 'NE'), ('PTO et CAB presents', 'PTO et CAB presents'), ('conformes a remplacer', 'conformes a remplacer'), ('PTO a remettre en conformité et CAB conforme', 'PTO a remettre en conformité et CAB conforme'), ('PTO present et CAB non conforme a remplacer', 'PTO present et CAB non conforme a remplacer'), ('PTO mal positionné a déplacer et nouveau CAB a poser', 'PTO mal positionné a déplacer et nouveau CAB a poser'), ('PTO et CAB absent', 'PTO et CAB absent'), ('première pose nécessaire', 'première pose nécessaire'), ('PTO a deplacer par confort et nouveau CAB a poser', 'PTO a deplacer par confort et nouveau CAB a poser')], max_length=100, null=True)),
                ('synchro', models.CharField(blank=True, choices=[('OK', 'OK'), ('NOK', 'NOK')], max_length=3, null=True)),
                ('agent', models.CharField(max_length=255)),
                ('resultats_verification', models.CharField(blank=True, choices=[('Validé', 'Validé'), ('Débrief modifié', 'Débrief modifié'), ('Non validé', 'Non validé')], max_length=50, null=True)),
                ...
                ('statut_appel', models.CharField(blank=True, max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='DebriefRACC',
            fields=[
                ...
                ('tech', models.CharField(blank=True, max_length=255, null=True, verbose_name='Tech')),
                ('numero_technicien', models.CharField(blank=True, max_length=50, null=True, verbose_name='Numéro technicien')),
                ('nouveaux_tech', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nouveaux tech')),
                ('zone_manager', models.CharField(blank=True, max_length=255, null=True, verbose_name='Zone / manager')),
                ('code_cloture_technicien', models.TextField(blank=True, null=True, verbose_name='Code clôture technicien')),
                ('reference_pm', models.CharField(blank=True, max_length=255, null=True, verbose_name='Référence PM')),
                ('appel_tech', models.CharField(blank=True, choices=[("Pas d'appel", "Pas d'appel"), ('Appel à chaud', 'Appel à chaud')], max_length=20, null=True, verbose_name='Appel tech')),
                ('synchro', models.CharField(blank=True, choices=[('Echec', 'Echec'), ('Taguées', 'Taguées')], max_length=20, null=True, verbose_name='Synchro')),
                ('secteur', models.CharField(blank=True, max_length=255, null=True, verbose_name='Secteur')),
                ('type_echec', models.CharField(blank=True, choices=[('Echec client', 'Echec client'), ("Echec d'acces", "Echec d'acces")], max_length=50, null=True, verbose_name="Type d'échec")),
                ('pec_par', models.CharField(blank=True, max_length=255, null=True, verbose_name='PEC par')),
                ('resultat_controle', models.CharField(blank=True, choices=[('RAS', 'RAS')], max_length=10, null=True, verbose_name='Résultat du contrôle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jeton', models.CharField(blank=True, default='', max_length=255, verbose_name='Jeton')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_technicien', models.CharField(blank=True, max_length=255, null=True, verbose_name='Log Technicien')),
                ('mdp', models.CharField(blank=True, max_length=255, null=True, verbose_name='Mot de passe')),
                ('numero_technicien', models.CharField(blank=True, max_length=50, null=True, verbose_name='Numéro du Technicien')),
                ('societe', models.CharField(blank=True, max_length=255, null=True, verbose_name='Société')),
                ('nom_prenom_grdv', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nom prénom Grdv')),
                ('id_grdv', models.CharField(blank=True, max_length=255, null=True, verbose_name='ID Grdv')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('chef_plateau', 'Chef de plateau'), ('manager', 'Manager'), ('agent', 'Agent'), ('technicien', 'Technicien'), ('direction', 'Direction'), ('user', 'Utilisateur')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jeton_commande', models.CharField(blank=True, max_length=10, verbose_name='Jeton commande')),
                ('techniciens', models.CharField(blank=True, max_length=255, verbose_name='Techniciens (provenant de ARD2.technicien)')),
                ('numero', models.CharField(blank=True, max_length=50, verbose_name='Numéro (récupéré via les paramètres)')),
                ('departement', models.CharField(blank=True, max_length=255, verbose_name='Département (provenant de ARD2.departement)')),
                ('societe', models.CharField(blank=True, max_length=255, verbose_name='Société')),
                ('pec', models.CharField(blank=True, max_length=255, verbose_name='PEC (saisi manuellement)')),
                ('statut', models.CharField(blank=True, choices=[('Cloturée', 'Cloturée'), ('Taguée', 'Taguée')], max_length=20, verbose_name='Statut (calculé automatiquement)')),
                ...
                ('heure_debut', models.TimeField(blank=True, null=True, verbose_name='Heure début (provenant de ARD2.debut_intervention)')),
                ('heure_fin', models.TimeField(blank=True, null=True, verbose_name='Heure fin (provenant de ARD2.fin_intervention)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secteur', models.CharField(blank=True, max_length=255, null=True, verbose_name='Secteur')),
                ('integration', models.CharField(blank=True, max_length=255, null=True, verbose_name='Intégration')),
                ('zone_manager', models.CharField(blank=True, max_length=255, null=True, verbose_name='Zone / Manager')),
                ('termine', models.BooleanField(default=False, verbose_name='Terminé')),
                ('synchro', models.CharField(blank=True, choices=[('Echec', 'Echec'), ('Taguée', 'Taguée')], max_length=10, null=True, verbose_name='Synchro')),
                ('reference_pm', models.CharField(blank=True, max_length=50, null=True, verbose_name='Référence PM')),
                ('issu_intervention', models.TextField(blank=True, null=True, verbose_name="Issu de l'intervention")),
                ('pec_par', models.CharField(blank=True, max_length=255, null=True, verbose_name='PEC par')),
                ('code_cloture', models.TextField(blank=True, null=True, verbose_name='Code clôture')),
                ('debrief', models.TextField(blank=True, null=True, verbose_name='Débrief')),
                ('photos', models.TextField(blank=True, null=True, verbose_name='Photos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('commentaire', models.TextField(verbose_name='Commentaire')),
                ('created_date', models.DateField(blank=True, null=True, verbose_name='Date du commentaire')),
                ('created_time', models.TimeField(blank=True, null=True, verbose_name='Heure du commentaire')),
